...
function ResponsiveAppBarSSR({ data }: InferGetServerSidePropsType<typeof getServerSideProps>) {
          ...
          <Container maxWidth="xl">
            ...
            >
              ...
              <Box sx={{ flexGrow: 1, display: { xs: "flex", md: "none" } }}>
                ...
                >
                  {Array.from(data).map((page, index) => (
              ...
              <Button
                ...
                sx={{ mx: 'auto',m: 2,my: 2, color: 'white', display: 'block' }}
              >
                <Link href={page.path} target={page.targets}>
                {page.name}
                </Link>
...
export default ResponsiveAppBarSSR;